app.controller('scheduleController', function ($scope, scheduleService, schedulesResource) {
    ...
    $scope.RecurrenceTabs = [
        { title:'Mon', content:'Monday' },
        { title:'Tue', content:'Tuesday' },
        { title:'Wed', content:'Wednesday' },
        { title:'Thu', content:'Thursday' },
        { title:'Fri', content:'Friday' },
        { title:'Sat', content:'Saturday' },
        { title:'Sun', content:'Sunday' }
    ];


    $scope.customerOptions = [
        {name: 'Daily', value: 'daily'},
        {name: 'Weekely', value: 'weekly'},
